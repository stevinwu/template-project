...
export const extendsConfig = {
  data() {
    return {
      ...
      userInfoUrl: 'http://hr.**.com', //顶部导航头个人信息url
      signOutUrl: 'http://oa.**.net/common/apps/userAction.php?action=signout', //顶部导航头退出登录url 
      signInUrl: 'http://oa.***.net/user/common/signin.php'
    }
  }
}